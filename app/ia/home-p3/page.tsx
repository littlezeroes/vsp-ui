...
import { Eye, ArrowLeftRight, Send, QrCode, ChevronRight, Bell, Shield, TrendingUp, Clock, Zap, Droplets, Wifi, Smartphone, AlertCircle, PieChart, User } from "lucide-react"
    ...
    <div className="relative w-full max-w-[390px] min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="h-[56px] px-[22px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-[8px]">
          ...
          <button className="w-[36px] h-[36px] rounded-full bg-foreground flex items-center justify-center">
      ...
      <div className="flex-1">
            ...
            <div className="mt-[14px] w-full bg-background/12 rounded-[14px] px-[14px] py-[10px] flex items-center justify-between">
              <div className="flex items-center gap-[8px]">
                ...
                <div>
                  ...
                  <p className="text-[14px] font-bold">12.500.000 đ</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-[12px] font-bold">+45.000 đ</p>
        ...
        <section className="px-[22px] pt-[16px]">
          <button className="w-full bg-secondary rounded-[20px] p-[14px] text-left">
            ...
            <p className="text-[22px] font-bold">32.500.000<span className="text-[14px] ml-1">đ</span></p>
            <div className="flex gap-[12px] mt-[8px]">
              <div>
                <p className="text-[10px] text-foreground-secondary">Sinh lời</p>
                <p className="text-[12px] font-semibold">12,5 triệu</p>
              </div>
              <div>
