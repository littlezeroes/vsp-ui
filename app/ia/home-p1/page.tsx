...
import { Eye, ArrowLeftRight, Send, QrCode, ChevronRight, Bell, Shield, TrendingUp, Clock, Zap, Droplets, Wifi, Smartphone, AlertCircle } from "lucide-react"
      ...
      <div className="flex-1">
        ...
        <section className="px-[22px] pt-[8px]">
          <div className="bg-foreground text-background rounded-[28px] p-[20px]">
            ...
            <button className="mt-[14px] w-full bg-background/15 rounded-full py-[9px] flex items-center justify-center gap-[6px]">
              <TrendingUp size={15} className="opacity-80" />
              <span className="text-[12px] font-semibold opacity-90">Kích hoạt Sinh lời — 5,5%/năm</span>
            </button>
          </div>
        </section>
        ...
        <section className="px-[22px] pt-[32px]">
          <button className="w-full bg-secondary rounded-[20px] p-[14px] flex items-center gap-[12px] text-left">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[14px] font-semibold">Hoá đơn sắp đến hạn</p>
              <p className="text-[12px] text-foreground-secondary">EVN Hà Nội · 380.000 đ · Hạn 15/04</p>
            </div>
        ...
        <section className="px-[22px] pt-[32px]">
          <button className="w-full bg-secondary rounded-[20px] p-[14px] flex items-center gap-[12px] text-left">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[14px] font-semibold">Bảo hiểm xe TNDS</p>
              <p className="text-[12px] text-foreground-secondary">Mua từ 66.000 đ</p>
            </div>
        ...
        <section className="px-[22px] pt-[32px] pb-[16px]">
          <div className="bg-secondary rounded-[20px] p-[14px] relative">
            <button className="absolute top-[10px] right-[10px] w-[22px] h-[22px] rounded-full bg-foreground/8 flex items-center justify-center">
              <span className="text-[10px] font-bold text-foreground-secondary">&times;</span>
            </button>
            <p className="text-[13px] font-semibold">Chứng chỉ quỹ từ 50.000 đ</p>
            <p className="text-[11px] text-foreground-secondary mt-[2px]">Bắt đầu đầu tư với số vốn nhỏ</p>
          </div>
        </section>
      </div>
